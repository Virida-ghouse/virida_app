              ...
              {automationRules.length === 0 ? (
                <tr>
                  <td colSpan={5} className="p-12 text-center">
                    <p className="text-gray-400">Aucune règle d'automatisation configurée</p>
                  </td>
                </tr>
              ) : (
                  ...
                  >
                    <td className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-white font-semibold text-lg">{rule.name}</span>
                      </div>
                    </td>
                    <td className="p-4 hidden md:table-cell">
                      <div className="flex items-center gap-2">
                        <span className="material-symbols-outlined text-[#2AD368] text-sm">rule</span>
                        <span className="text-gray-300 text-sm">{rule.condition}</span>
                      </div>
                    </td>
        ...
        <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="glass-card backdrop-blur-xl rounded-3xl w-full max-w-xl border-2 border-[#2AD368]/20 shadow-2xl">
            ...
            <div className="p-6 space-y-4">
              <div>
                <label className="block text-sm font-semibold text-gray-300 mb-2">Nom de la règle</label>
                <input
                  type="text"
