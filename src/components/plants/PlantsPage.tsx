    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <CardContent>
          <FilterSection>
            ...
            <FormControl size="small" sx={{ minWidth: 200 }}>
              <InputLabel sx={{ color: '#8091A0' }}>Catégorie</InputLabel>
              <Select
            ...
            <FormControl size="small" sx={{ minWidth: 200 }}>
              <InputLabel sx={{ color: '#8091A0' }}>Santé</InputLabel>
              <Select
      ...
      {filteredPlants.length > 0 && (
        <Box sx={{ display: 'flex', gap: 1, mb: 3, flexWrap: 'wrap' }}>
          ...
          />
          <Chip
            label={`À surveiller: ${filteredPlants.filter((p) => p.health < 60).length}`}
            sx={{
              background: '#f1c40f20',
              color: '#f1c40f',
            }}
